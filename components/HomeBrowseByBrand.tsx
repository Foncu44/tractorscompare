...
export default function HomeBrowseByBrand({ brands }: HomeBrowseByBrandProps) {
  // Top brands: John Deere, Kubota, McCormick, and 3 more popular ones
  const topBrands = ['John Deere', 'Kubota', 'McCormick'];
  const otherBrands = brands
    .filter(b => !topBrands.includes(b))
    .slice(0, 3);
    ...
    <section className="py-8 md:py-12 bg-white">
      <div className="container-custom">
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center gap-2 md:gap-3">
                  ...
                  <h3 className="font-semibold text-gray-900 group-hover:text-primary-600 transition-colors text-xs md:text-sm lg:text-base">
                    {brand}
                  </h3>
                </div>
              </Link>
        ...
        <div className="text-center mt-6 md:mt-8">
          <Link
            href="/marcas"
            className="inline-flex items-center text-primary-600 hover:text-primary-700 font-semibold transition-colors text-sm md:text-base"
          >
            View all brands →
          </Link>
        </div>
