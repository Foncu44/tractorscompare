          ...
          <div className="max-w-4xl mx-auto prose prose-lg prose-sm md:prose-lg">
            ...
            <div className="bg-gradient-to-r from-primary-50 to-primary-100 rounded-xl p-4 md:p-6 mt-6 md:mt-8 border border-primary-200">
              ...
              <div className="flex flex-wrap gap-2 md:gap-3 mt-3 md:mt-4">
                <Link href="/best" className="inline-flex items-center px-3 md:px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors text-xs md:text-sm font-semibold">
                  Best Tractors
                </Link>
