...
export const metadata = {
  title: 'Agricultural Tractors - Brands & models',
  description: 'Browse agricultural tractor specifications by brand. Filter and sort brands to access models and spec sheets.',
};
...
export default function TractoresAgricolasPage({ searchParams = {} }: PageProps) {
  const q = (searchParams.q || '').trim().toLowerCase();
  const sort = searchParams.sort || 'name';

  const farmTractors = tractors.filter((t) => (t.type || 'farm') === 'farm');
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="border-b border-gray-200 bg-white py-4">
        <div className="container-custom">
          <form className="flex flex-col sm:flex-row gap-4 items-center justify-between" action="/tractores-agricolas" method="GET">
